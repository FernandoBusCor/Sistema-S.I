...
public class ConsultasUser extends javax.swing.JFrame {
   ...
   volatile int clave;
    public ConsultasUser(int clave) {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 610, 140));
        ...
        empresa.setForeground(new java.awt.Color(0, 51, 255));
        empresa.setText("TecnoPerformance");
        getContentPane().add(empresa, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 20, 200, 30));
        ...
        getContentPane().add(jTextPuesto, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 320, 110, 30));
        ...
        jLabelfondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/elegante-fondo-blanco-lineas-brillantes_1017-17580.jpg"))); // NOI18N
